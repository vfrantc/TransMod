...
class DecomNet(nn.Module):
    def __init__(self, channel=64, kernel_size=3):
        ...
        self.net1_conv0 = QuaternionConv(4, channel, kernel_size * 3, stride=1, padding=4)
        # Activated layers!
        self.net1_convs = nn.Sequential(QuaternionConv(channel, channel, kernel_size, stride=1, padding=1),
                                        ...
                                        nn.ReLU())
        # Final recon layer
        self.net1_recon = QuaternionConv(channel, 4, kernel_size, stride=1, padding=1)
    ...
    def forward(self, input_im):
        ...
        L = torch.sigmoid(outs[:, :1, :, :])
        R = torch.sigmoid(outs[:, 1:4, :, :])
        return R, L
...
class RelightNet(nn.Module):
    def __init__(self, channel=64, kernel_size=3):
        ...
        self.relu = nn.ReLU()
        self.net2_conv0_1 = QuaternionConv(4, channel, kernel_size, padding=1)
        self.net2_conv1_1 = QuaternionConv(channel, channel, kernel_size, stride=2, padding=1)
        self.net2_conv1_2 = QuaternionConv(channel, channel, kernel_size, stride=2, padding=1)
        self.net2_conv1_3 = QuaternionConv(channel, channel, kernel_size, stride=2, padding=1)
        self.net2_deconv1_1 = QuaternionConv(channel * 2, channel, kernel_size, padding=1)
        self.net2_deconv1_2 = QuaternionConv(channel * 2, channel, kernel_size, padding=1)
        self.net2_deconv1_3 = QuaternionConv(channel * 2, channel, kernel_size, padding=1)
        self.net2_fusion = QuaternionConv(channel * 3, channel, kernel_size=1, padding=1)
