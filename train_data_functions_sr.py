...
class TrainData(data.Dataset):
    ...
    def get_images(self, index):
        ...
        # modify this code in order to use <super resolution>
        ...
        # take the crop of double size then
        x, y = randrange(0, width - crop_width + 1), randrange(0, height - crop_height + 1)
        input_crop_img = input_img.crop((x, y, x + crop_width, y + crop_height))
        input_crop_img = input_crop_img.resize((crop_width//2, crop_height//2), Image.BICUBIC)
