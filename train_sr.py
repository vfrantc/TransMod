...
from train_data_functions_sr import TrainData
from val_data_functions_sr import ValData
...
import numpy as np
import random
from transweather_model_sr import Transweather
...
# the crop size is during thraining, and the block for transformer should be smaller than it
